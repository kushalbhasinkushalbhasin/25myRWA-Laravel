...
<html lang="en">
  <head>
    ...
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/fontawesome-pro-5/css/all.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/bootstrap-select/css/bootstrap-select.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/slick/slick.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/magnific-popup/magnific-popup.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/jquery-ui/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/chartjs/Chart.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/dropzone/css/dropzone.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/animate.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/timepicker/bootstrap-timepicker.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/mapbox-gl/mapbox-gl.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/vendors/dataTables/jquery.dataTables.min.css')}}">
    <link rel="stylesheet" href="{{asset('laravel/assets/css/custome.css')}}">
    <!-- Themes core CSS -->
    <link rel="stylesheet" href="{{asset('laravel/assets/css/themes.css')}}">
    <!-- Favicons -->
    <link rel="icon" href="RWAVendor/clients/favicon/{{app('client')->favicon}}">
    <!-- Twitter -->
  ...
  <body>
    ...
    <a href="https://wa.me/447470169440" class="whatsapp-green fs-25 px-4" target="_blank" rel="noopener noreferrer">
        <i class="fab fa-whatsapp"></i>
          ...
          <div class="col-md-6 col-lg-3 mb-6 mb-md-0">
            ...
            <ul class="list-group list-group-flush list-group-no-border">
              <li class="list-group-item bg-transparent p-0">
                <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Home</a>
              </li>
              <li class="list-group-item bg-transparent p-0">
                <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Contact Us</a>
              </li>
              <!--<li class="list-group-item bg-transparent p-0">-->
              <!--  <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Site Map</a>-->
              <!--</li>-->
              <!--<li class="list-group-item bg-transparent p-0">-->
              <!--  <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Advertise with us</a>-->
              <!--</li>-->
              <!--<li class="list-group-item bg-transparent p-0">-->
    ...
    <!-- Vendors scripts -->
    <script src="{{asset('laravel/assets/vendors/jquery.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/jquery-ui/jquery-ui.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/bootstrap/bootstrap.bundle.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/bootstrap-select/js/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/slick/slick.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/waypoints/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/counter/countUp.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/chartjs/Chart.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/dropzone/js/dropzone.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/timepicker/bootstrap-timepicker.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/hc-sticky/hc-sticky.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/jparallax/TweenMax.min.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/mapbox-gl/mapbox-gl.js')}}"></script>
    <script src="{{asset('laravel/assets/vendors/dataTables/jquery.dataTables.min.js')}}"></script>
    <!-- Theme scripts -->
    <script src="{{asset('laravel/assets/js/theme.js')}}"></script>
